...
const ProjectSuccess: React.FC = () => {
  return (
    <section id="success-rate" className="py-20 bg-gray-900/70">
      <div className="container mx-auto px-6">
        <div className="max-w-4xl mx-auto text-center">
          <div className="text-cyan-400 inline-block mb-6">
          ...
          <div className="mt-10">
            <a
              ...
              className="text-cyan-400 hover:text-cyan-300 font-semibold transition-colors text-lg inline-flex items-center group"
            >
